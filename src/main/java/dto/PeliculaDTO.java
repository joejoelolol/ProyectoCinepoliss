...
public class PeliculaDTO {
    ...
    public PeliculaDTO(int id, String titulo, Clasificacion clasificacion, Time duracion, String pais, String sinopsis, String trailer) {
        this.id = id;
        this.titulo = titulo;
    ...
    public PeliculaDTO(int id, String titulo, Clasificacion clasificacion, Time duracion, String pais, String sinopsis) {
        this.id = id;
        this.titulo = titulo;
        this.clasificacion = clasificacion;
        this.duracion = duracion;
    ...
    public String toString() {
        return "PeliculaDTO{" + "id=" + id + ", titulo=" + titulo + ", clasificacion=" + clasificacion + ", duracion=" + duracion + ", pais=" + pais + ", sinopsis=" + sinopsis + ", trailer=" + trailer + '}';
    }
}
