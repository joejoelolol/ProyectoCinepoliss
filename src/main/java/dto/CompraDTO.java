...
public class CompraDTO {
    ...
    public CompraDTO(int id, MetodoPago metodoPago, int idCliente, int idFuncion) {
        this.id = id;
    ...
    public String toString() {
        return "CompraDTO{" + "id=" + id + ", costo=" + costo + ", fechaHora=" + fechaHora + ", metodoPago=" + metodoPago + ", idCliente=" + idCliente + ", idFuncion=" + idFuncion + '}';
    }
}
