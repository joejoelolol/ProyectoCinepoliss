...
public class FuncionDTO {
    ...
    public FuncionDTO(int id, Time horaInicio, DiaSemana dia, int idSala, int idPelicula) {
        this.id = id;
    ...
    public String toString() {
        return "FuncionDTO{" + "id=" + id + ", costo=" + costo + ", horaInicio=" + horaInicio + ", horaFin=" + horaFin + ", dia=" + dia + ", idSala=" + idSala + ", idPelicula=" + idPelicula + '}';
    }
}
