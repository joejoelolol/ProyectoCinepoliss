...
public class Sala {
    ...
    public Sala(int id, String nombre, Time tiempoLimpieza, double costo, int capacidad, String nombreSucursal) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Sala{" + "id=" + id + ", nombre=" + nombre + ", tiempoLimpieza=" + tiempoLimpieza + ", costo=" + costo + ", horaDesocupada=" + horaDesocupada + ", capacidad=" + capacidad + ", nombreSucursal=" + nombreSucursal + '}';
    }
}
